   ...
   private void fillDatabase()
   {
      try {
         connection.prepareStatement("INSERT INTO PUBLIC.configuration " +
               ...
               "(null, 'authentication_active', 'true', 'boolean', 'When checked the authentication is activated, meaning devices must be accepted before they can use the OpenRemote Controller.<br/>If not checked there is no authentication and no SSL security active.')")
               .execute();  
      } catch (SQLException e) {

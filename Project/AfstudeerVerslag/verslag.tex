...
onze stage hebben aangepakt, welke tools we hebben gebruikt en wat voor
resultaten we hebben bereikt. 

Tijdens de stage hebben we veel geleerd over beveiliging. Toen we begonnen met
de stage was onze kennis van security nog niet erg "goed". Samen met Berry
...
gehad hebben. Tevens willen we Berry Borger bedanken voor de technische
beleiding, informatie en advies op security gebied. Ook willen we Bas Burgers

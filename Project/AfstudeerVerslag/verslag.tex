...
In de presentatie kan niet alles getoond worden wat er is uitgevoerd en bereikt
tijdens de afstudeerstage. Om alles toch goed toe te lichten hebben we dit
verslag opgesteld.  Onze docent en derde beoordelaar kunnen in dit verslag
nalezen hoe wij onze stage hebben aangepakt, welke tools we gebruikt hebben en
wat voor resultaten we hebben bereikt.
...
het gebruiksvriendelijkst en best beveiligd kan worden.

...
/*
Aangezien het lastig is om alles in een presentatie duidelijk te maken wat er
gebeurd is in de 5 maanden die de afstudeerstage heeft geduurd schrijven we dit
verslag.*/ Onze docent en derde beoordelaar kunnen in dit verslag nalezen hoe wij
onze stage hebben aangepakt, welke tools we gebruikt hebben en wat voor
resultaten we hebben bereikt.

Tijdens de stage hebben we veel geleerd over beveiliging. Toen we begonnen met
de stage was onze kennis van security nog redelijk beperkt. Samen met Berry
Borgers, een van onze technische begeleiders, hebben we een aantal keuzes
...
Tevens was het een onderzoeksproject, om te kijken wat de mogelijkheden zijn van
SSL in kleinere systemen.
*/
...
het actuele nieuws. Zo is KPN onlangs wederom weer gehackt en dit keer door een 17
jarige jongen of
...
mogelijkheid van beperkte beveiliging aanwezig is, wordt er gekeken naar betere
alternatieve om dit product te beveiligen en later uit te breiden. Het zou een
...
hoofdstukken, zoals onderandere probleemanalyse, methoden en technieken en resultaten.
...
administrator panel is een webbased applicatie en behoord tot de OpenRemote
Controller. Op de OpenRemote Modeler kunnen er groepen gemaakt worden en
gekoppeld worden aan knoopen, sliders en/of switches, waarna je deze groepen in
de administrator panel kan koppelen aan apparaten.
...
Ook is ervoor gezorgd dat onze uitbreidingen op OpenRemote simpel uit te zetten
...
Tevens is er ook contact opgenomen met OpenRemote om onze vorderingen te tonen.
...
Al bij al is het DomoTop project succesvol afgerond. OpenRemote is nu beveiligd
...
gebruik kan maken van onze technieken om OpenRemote te beveiligen. 

In dit project zijn niet alle wensen verwerkt in het project. Het eerste waar
...
de iOS client niks veranderd en kan deze dus niet worden gebruikt om onze

...
volgende onderzoek wat is gehouden was naar het
...
Borgers aangezien hij over veel kennis beschike met betrekking tot het
beveilingsgebied. De keuzes
die zijn gemaakt in het document is in overleg met Berry Borgers gebeurd. Dit
onderzoek is gedocumenteerd in het Engels zodat het makkelijkst te delen is met
de ontwikkelaars van OpenRemote.  Alle onderzoeken zijn gedocumenteerd in
verschillende documenten die te vinden zijn in de bijlages.
...
getekend is door de CA, die aanwezig is in de truststore van TomCat, vertrouwd
TomCat deze client en krijgt het apparaat toegang tot de OpenRemote Controller.

Toen het bovenstaande allemaal naar behoren werkte, werd er verder gegaan met het
...
veiligheidsredenen. Als de certificaten overgestuurd worden, wordt namelijk ook
de private key over de lijn gestuurd wat ervoor kan zorgen dat deze onderschept
wordt. Het is dus verstandig om zoveel mogelijk acties lokaal op android uit te
...
vervolgens kan opslaan in \'e\'en keystore op de server, zodat er op een langer
...
OpenRemote Composer (ook wel Modeler genoemd) is het nu mogelijk om groepen toe
...
controleert de OpenRemote Controller door middel van het client certificaat tot
welke groep de client behoord om vervolgens te controleren of deze groep ook
...
waar verschillende eisen afgerond worden. Na afloop van een iteratie
...
gestuurd naar de client. Dit certificaat wordt gegenereerd op de server,n
...
om makkelijk en gebruiksvriendelijk meerdere groepen te kunnen selecteren.

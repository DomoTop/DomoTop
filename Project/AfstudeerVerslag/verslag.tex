...
Dit ontwerp wordt opgeslagen in de Beehive en via de Beehive kunnen deze wordt
gesynchroniseerd naar de Controller en via de Controller in geladen in de
client. Door middel van deze interface kan de Client commando's 
...
\begin{figure}[htpb]
   \begin{center}
     \includegraphics[height=\textheight]{OpenremoteControllerAd.pdf}
   \end{center}
